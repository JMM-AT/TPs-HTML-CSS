...
Ce dépôt contient trois dossiers principaux conçus de manière croissante en difficulté :

*   **`/tp1`** : Premier TP - Fondamentaux HTML/CSS (Balises de bases, structure du document).
*   **`/tp2`** : Deuxième TP - Mise en page et formulaires (Positionnement, inputs, alignement).
*   **`/tp3`** : Troisième TP complet - Site vitrine multi-pages, design moderne, effets de verre *Glassmorphism* et système de grilles complexes.
...
*   `index.html` : Page d'accueil dynamique avec intégration de vidéo de présentation.
*   `pages/about.html` : Présentation détaillée de l'équipe et des valeurs de l'entreprise.
*   `pages/service.html` : Détail des prestations offertes et tableau comparatif des prix.
...
*   **Layout & Responsivité** : Utilisation intensive de Flexbox et CSS Grid pour une mise en page fluide, adaptative et totalement responsive.
*   **Composants Avancés** : Effets de *Glassmorphism* (verre dépoli) saisissant grâce à l'exploitation de la propriété `backdrop-filter`.
